...
if ('serviceWorker' in navigator) navigator.serviceWorker.register('./sw.js?v=52', { updateViaCache: 'none' }).then(registration => registration.update()).catch(() => {});
