...
if ('serviceWorker' in navigator) navigator.serviceWorker.register('./sw.js?v=53', { updateViaCache: 'none' }).then(registration => registration.update()).catch(() => {});
